//#region node_modules/.nitro/vite/services/ssr/assets/football-Bg2Gurrr.js
function L(id, en, fa, ar, tr, az, ur, ku) {
	return {
		id,
		en,
		fa,
...
function labeled(list, id, locale) {
	if (!id) return "—";
...
//#endregion
export { POSITIONS as a, VIDEO_CATEGORIES as c, PITCH_COORDS as i, WIDE_PITCH_COORDS as l, FEET as n, REGIONS as o, LEVELS as r, SHORTLIST_STATUSES as s, COUNTRIES as t, labeled as u };
