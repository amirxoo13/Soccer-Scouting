...
export const fa: Messages = {
  ...
  auth: {
    ...
    exists: "این ایمیل قبلاً ثبت شده. الان وارد می‌شوید.",
    invalid: "ایمیل یا رمز عبور درست نیست.",
  },
  onboarding: {
  ...
  analysis: {
    ...
    kickoff: "شروع بازی تشخیص داده شد",
    pitch: "زمین و خطوط",
    referee: "داور",
    teamIssues: "ضعف‌های تیمی روی زمین",
    tightHint: "زاویه دوربین بسته است؛ فقط بازیکن‌های داخل تصویر آنالیز شدند.",
    home: "میزبان",
    away: "میهمان",
    markTitle: "بازیکن را روی تصویر علامت بزنید",
    markHint: "روی کادر طلایی همان نفر بزنید. گزارش فقط دربارهٔ اوست، نه کل زمین.",
    markCta: "آنالیز این بازیکن",
    remake: "انتخاب بازیکن دیگر",
    position: "پست",
    role: "نقش",
    level: "سطح",
    attributes: "ویژگی‌های فردی",
    firstTouch: "کنترل اول",
    weakerFoot: "پای غیرتخصصی",
    scanning: "اسکن محیط",
    acceleration: "شتاب",
    agility: "چابکی",
    passing: "پاس",
    ...
    phase: "فاز بازی",
    formation: "آرایش",
    recommendation: "نظر اسکات",
    notes: "یادداشت اسکات",
    strengths: "نقاط قوت",
    weaknesses: "نقاط ضعف",
    disclaimer: "این گزارش از چند فریم کلیپ است، نه ترکینگ ۹۰ دقیقه‌ای اپتا یا وایسکات.",
    status: {
      idle: "آنالیز نشده",
      queued: "در صف",
      running: "در حال خواندن تک‌تک بازیکنان",
      awaiting_mark: "گزارش آماده است",
      analyzed: "گزارش تک‌به‌تک بازیکنان آماده است",
      extraction_failed: "خواندن این لینک ممکن نشد",
