...
export const fa: Messages = {
  ...
  analysis: {
    ...
    strengths: "نقاط قوت",
    weaknesses: "نقاط ضعف",
    disclaimer: "برآورد از فریم‌های کلیپ و مدل بینایی اسکات. دادهٔ ترکینگ پخش زنده نیست.",
    status: {
      idle: "آنالیز نشده",
      queued: "در صف",
      running: "در حال پیدا کردن بازیکنان",
      awaiting_mark: "یک بازیکن را علامت بزنید",
      analyzed: "گزارش اسکات آماده است",
