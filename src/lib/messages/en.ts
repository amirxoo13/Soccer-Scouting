export const en = {
  ...
  analysis: {
    ...
    disclaimer: "Estimates from clip stills and a licensed-scout vision model. Not broadcast tracking data.",
    status: {
      idle: "Not analysed",
      queued: "Queued",
      running: "Finding players in the clip",
      awaiting_mark: "Mark one player",
      analyzed: "Scout report ready",
